...
Forked repository of Sequelize in order to make it compatible with indexHints in the included joins, for more information see https://github.com/sequelize/sequelize/pull/11808
